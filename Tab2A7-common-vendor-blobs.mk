...
LOCAL_PATH := vendor/lenovo/Tab2A7-common
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/proprietary/system/lib/libbtcusttable.so:system/lib/libbtcusttable.so \
    $(LOCAL_PATH)/proprietary/system/lib/libMtkVideoTranscoder.so:system/lib/libMtkVideoTranscoder.so \
    $(LOCAL_PATH)/proprietary/system/lib/liba3m.so:system/lib/liba3m.so \
    $(LOCAL_PATH)/proprietary/system/lib/libja3m.so:system/lib/libja3m.so \
    ...
    $(LOCAL_PATH)/proprietary/system/bin/rtt:system/bin/rtt \
